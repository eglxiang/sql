...
get_ipython().magic('sql SHOW columns FROM users')
...
get_ipython().magic('sql SHOW columns FROM site_activities')
...
get_ipython().magic('sql SELECT breed FROM dogs')
...
get_ipython().magic('sql SELECT breed FROM dogs LIMIT 5')
...
get_ipython().magic('sql SELECT breed FROM dogs LIMIT 10 OFFSET 3')
...
get_ipython().magic('sql SELECT breed, breed_type, breed_group FROM dogs LIMIT 3,10')
...
get_ipython().magic('sql SELECT * FROM dogs LIMIT 5, 10;')
...
get_ipython().magic('sql SELECT activity_type, created_at, updated_at FROM site_activities LIMIT 10 OFFSET 50')
...
get_ipython().magic('sql SELECT * FROM users LIMIT 20 OFFSET 2000')
...
get_ipython().magic('sql SELECT * from users limit 10')
