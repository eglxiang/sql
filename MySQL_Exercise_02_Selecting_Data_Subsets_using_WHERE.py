...
get_ipython().magic('sql SELECT user_guid FROM users WHERE free_start_user=1;')
...
get_ipython().magic('sql SELECT dog_guid FROM dogs WHERE dna_tested=1;')
...
get_ipython().magic('sql SELECT user_guid FROM users WHERE membership_type=2')
...
get_ipython().run_cell_magic('sql', 'SELECT *', "FROM users\nWHERE state IN ('NY', 'NC')")
...
get_ipython().magic("sql SELECT dog_guid, created_at FROM complete_tests WHERE created_at < '2015-10-15'")
...
get_ipython().magic('sql SELECT user_guid FROM users WHERE state IS NOT NULL;')
...
get_ipython().magic('sql SELECT dog_guid, subcategory_name, test_name FROM reviews WHERE YEAR(created_at)=2014 LIMIT 10')
...
get_ipython().magic("sql SELECT user_guid FROM dogs WHERE gender='female' AND breed LIKE ('%terrier%')")
...
get_ipython().run_cell_magic('sql', 'SELECT dog_guid, test_name, subcategory_name FROM complete_tests ', 'WHERE MONTH(created_at)=10 AND YEAR(created_at)=2014 LIMIT 100')
